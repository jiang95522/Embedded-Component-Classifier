...
u8 TP_Init(void)
{
    ...
    else
    {
        ...
        GPIO_Set(GPIOI, PIN3 | PIN8, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_SPEED_MID, GPIO_PUPD_PU);	//PI3/PI8设置为推挽输出
        GPIO_Set(GPIOH, PIN6, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_SPEED_MID, GPIO_PUPD_PU);		//PH6设置为推挽输出
