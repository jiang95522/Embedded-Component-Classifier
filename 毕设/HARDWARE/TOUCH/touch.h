...
//电阻屏芯片连接引脚	   
#define PEN		  		GPIO_Pin_Get(GPIOH,PIN7)  		//T_PEN
#define DOUT	 		GPIO_Pin_Get(GPIOG,PIN3)   		//T_MISO
#define TDIN(x)	 		GPIO_Pin_Set(GPIOI,PIN3,x)  	//T_MOSI
#define TCLK(x)	 		GPIO_Pin_Set(GPIOH,PIN6,x)  	//T_SCK
#define TCS(x)	  		GPIO_Pin_Set(GPIOI,PIN8,x) 		//T_CS  
